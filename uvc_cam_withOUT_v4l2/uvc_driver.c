...
static __u32 uvc_colorspace(const __u8 primaries)
{
    static const __u8 colorprimaries[] = {
        0,
        VIDEO_COLORSPACE_SRGB,
        VIDEO_COLORSPACE_470_SYSTEM_M,
        VIDEO_COLORSPACE_470_SYSTEM_BG,
        VIDEO_COLORSPACE_SMPTE170M,
        VIDEO_COLORSPACE_SMPTE240M,
    };
        ...
        __u32 **intervals, unsigned char *buffer, int buflen)
{
    ...
    switch (buffer[2]) {
        case UVC_VS_FORMAT_UNCOMPRESSED:
            /* length of uncompressed format descriptor*/
...
/*iadd
    ret = alloc_chrdev_region(&dev.devno,1,1,DEV_NAME);
    if(ret <0)
        return -ENODEV;
    ...
    if(IS_ERR(dev.dev_class))
    {
        ...
        return PTR_ERR(dev.dev_class);
    }


    dev.device = device_create(dev.dev_class,NULL,dev.devno,NULL,DEV_NAME);
